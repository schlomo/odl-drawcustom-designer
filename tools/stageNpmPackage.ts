 ...
 * repo root serves both GitHub and npmjs.com — every link in it is an
 * absolute URL so it renders correctly on npmjs.com too. There is no
 * separate docs/npm-README.md anymore.
 */
